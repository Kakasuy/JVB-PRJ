...
export async function getStayCategories() {
  return [
    ...
    },
    {
      ...
      region: 'Netherlands',
      handle: 'amsterdam-netherlands',
      href: '/stay-categories/amsterdam-netherlands',
      count: 2500,
      thumbnail: 'https://images.pexels.com/photos/1388030/pexels-photo-1388030.jpeg',
      coverImage: {
        src: stayCategoryCoverImage.src,
        width: stayCategoryCoverImage.width,
        height: stayCategoryCoverImage.height,
      },
      description: 'Beautiful canals and historic architecture in the heart of Europe',
    },
    {
      id: 'stay-cat://3',
      name: 'Paris, France',
    ...
    },
    {
      ...
      region: 'Thailand',
      handle: 'bangkok-thailand',
      href: '/stay-categories/bangkok-thailand',
      count: 5000,
      ...
      description: 'Vibrant culture, street food, and magnificent temples in Southeast Asia',
    },
    {
      id: 'stay-cat://6',
      name: 'Barcelona, Spain',
      region: 'Spain',
      handle: 'barcelona-spain',
      href: '/stay-categories/barcelona-spain',
      count: 7500,
      thumbnail: 'https://images.pexels.com/photos/1386444/pexels-photo-1386444.jpeg',
      coverImage: {
        src: stayCategoryCoverImage.src,
        width: stayCategoryCoverImage.width,
        height: stayCategoryCoverImage.height,
      },
      description: 'Architecture, beaches, and vibrant nightlife in Catalonia',
    },
    {
      id: 'stay-cat://7',
      name: 'Roma, Italy',
